...
TILES = [
    ("SPRITE", (255, 206, 70), "World-space sprite quads via Atom; atlas UV, flip, transpose, point-filter pixel art; palette recolor for team colors."),
    ...
    ("ANIMATION", (200, 150, 255), "Flipbook; skeletal cutout, cross-fade, blend trees; DragonBones mesh deform + surface/FFD; .aseprite import; state machine."),
